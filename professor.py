...
logo = """
 ...
 |__   __| |          |  __ \          / _|                        
    ...
    | |  | | | |  __/ | |   | | | (_) | ||  __/\__ \__ \ (_) | |   
    |_|  |_| |_|\___| |_|   |_|  \___/|_| \___||___/___/\___/|_|   
...
def menu():
	...
	#INFORMATION OF USER
	print "~~~~~~~~~~~~~~~~~~~~~~~~"
	print "\x1b[32;1mThe×Professor/ Name >>"+namefb
	print "\x1b[34;1mThe×Professor/ ID >>"+id
	print '\x1b[33;1mThe×Professor/ TotalSub >>'+subid
	print "~~~~~~~~~~~~~~~~~~~~~~~~"
	print ""
	print "===================="
...
def option():
	unikers = raw_input("\n\x1b[31;1mThe\x1b[37;1mProfessor>>\x1b[33;1m")
	if unikers =="":
...
def startgrab():
	...
	p = ThreadPool(30)
	p.map(main, id)
        anime("\x1b[32;1m>>>>>>>>>>>>>>>\x1b[31;1mDESTROYER\x1b[37;1mSTAFF\x1b[32;1m<<<<<<<<<<<<<<<")
